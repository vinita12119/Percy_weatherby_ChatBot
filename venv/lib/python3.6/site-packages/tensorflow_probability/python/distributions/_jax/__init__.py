...
from tensorflow_probability.python.distributions._jax.vector_laplace_diag import VectorLaplaceDiag
from tensorflow_probability.python.distributions._jax.vector_sinh_arcsinh_diag import VectorSinhArcsinhDiag
